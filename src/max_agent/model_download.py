...
def download_qwen35_model(repository_root: Path, runner: Callable[[list[str]], None]) -> Path:
...
def validate_model_metadata(config: ModelConfig, repository_root: Path, model_file_download: SnapshotDownload) -> Path:
